...
class DataBase {
    ...
    func CreateRegionArray() {
        ...
        labelR46.name = "Fade"
        labelR46.posX = 3700 //2080
        labelR46.posY = 2200 //1784
        labelR46.posZ = 0
